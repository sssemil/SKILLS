...
-   W3C Cognitive Accessibility Guidance: Clear words, literal language, short text, separate steps, short critical paths, and no reliance on memory. It explicitly considers ADHD, but is advisory rather than required for WCAG conformance.
