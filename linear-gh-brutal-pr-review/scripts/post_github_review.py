...
def main() -> int:
    ...
    try:
        ...
        repo, pr_number, head_sha, summary, findings = validate_payload(payload)
        require_gh()
...
def validate_payload(payload: Any) -> tuple[str, int, str, str, list[Finding]]:
    ...
    return repo, pr_number, head_sha, summary, findings
